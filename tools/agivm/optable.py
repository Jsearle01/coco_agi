...
Generated by harness/tools/gen_opcode_table.py from the pinned oracle:
    ...
    engines/agi/opcodes.cpp + agi.h + view.h
...
# DIR_DX -- 9 entries, generated from the pinned oracle
DIR_DX = (0, 0, 1, 1, 1, 0, -1, -1, -1)

# DIR_DY -- 9 entries, generated from the pinned oracle
DIR_DY = (0, -1, -1, 0, 1, 1, 1, 0, -1)

# DIR_TABLE -- 9 entries, generated from the pinned oracle
DIR_TABLE = (8, 1, 2, 7, 0, 3, 6, 5, 4)

# LOOP_TABLE_2 -- 9 entries, generated from the pinned oracle
LOOP_TABLE_2 = (4, 4, 0, 0, 0, 4, 1, 1, 1)

# LOOP_TABLE_4 -- 9 entries, generated from the pinned oracle
