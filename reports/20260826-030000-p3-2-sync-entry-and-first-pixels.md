...
```
=== AC-10 -- the RGB capture run, and the gate re-run under the same driver ===
assembled build/pic_snap.bin  2462 bytes  (-DPIC_PRESENT)
...
(26880 pixels, 160 x 168)
  ...
  idx  AGI colour            pixels     %    probe byte -> GIME (R,G,B)  reads as
  ------------------------------------------------------------------------------------
    9  light blue             23678   88.1%      $0F -> (1,1,3)          blue
   15  white                   1964    7.3%      $3F -> (3,3,3)          white
